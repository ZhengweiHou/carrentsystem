...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <%cb.setEVERYPAGENUM(12);
			...
			List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select qc.*,title from qc AS qc LEFT JOIN type AS type ON qc.fl = type.id order by qc.id desc",9);
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(pagelist2.size()-1).toString() %> </td>
