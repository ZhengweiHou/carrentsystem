...
<DIV class="wrap" align=center>
						...
						<TBODY>
							<TR>
								<TD align=left class=head><FONT color=#000000>您现在的位置：<SPAN
										style="TEXT-DECORATION: none">投诉建议</FONT></TD>
							</TR>
						</TBODY>
					</TABLE>
				</TD>
						...
						<TBODY>
							<TR>
								<TD class=Ftd align=middle width="18%" rowSpan=2>
									...
									<DIV class=name><%=pagelist2.get(1).toString()%></DIV>
								</TD>
								<TD class=Ctd vAlign=top width="82%" height=75>
									<TABLE style="TABLE-LAYOUT: fixed; WORD-WRAP: break-word"
										...
										<TBODY>
											<TR>
												<TD class=content align=left><%=pagelist2.get(3).toString()%>
													<%
														if (!replay.isEmpty()) {
													%>
													<FIELDSET>
														...
														(署名:
														<%=replay.get(1).toString()%>/日期:<%=replay.get(2).toString()%>)
													</FIELDSET> <%
 	}
 %></TD>
											</TR>
							...
							<TR>
								<TD class=Atd width="82%">时间： <%=pagelist2.get(4).toString()%>
								</TD>
							</TR>
						</TBODY>
					</TABLE> <%
 ...
 %> <!--循环结束==================================================================-->
							...
							<TR>
								<TD align=right>
									<form action="" method="post" name="form3">
										...
										<a href="#" onClick="donext()"><img
											src="<%=basePath%>images/next.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
										<a href="#" onClick="golast()"><img
	...
	<TABLE class=dragTable height=28 cellSpacing=0 cellPadding=0 width=100%
		align=center border=0>
		<TBODY>
			<TR>
				<TD align=left class=head>&nbsp;投诉建议</TD>
			</TR>
			<TR>
				<TD class=middle>
					<STYLE type=text/css>
...
.unselected {
	BORDER-RIGHT: #edf8dd 1px solid;
	BORDER-TOP: #edf8dd 1px solid;
	FILTER: Alpha(opacity = 50);
	BORDER-LEFT: #edf8dd 1px solid;
	BORDER-BOTTOM: #edf8dd 1px solid
}
</STYLE> <SCRIPT>
	var prevIcon;
	function icon(num) {
		...
		document.all.face.value = num.childNodes(0).id;
					...
					<FORM name="form1" action="<%=basePath%>GuestBook.do?method=add"
						...
						<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
							...
							<TBODY>
								<TR>
									<TD width="24%" align="right">昵&nbsp;&nbsp;&nbsp;&nbsp;称:
									</TD>
									<TD align=left><INPUT name=nikename maxlength=20
										value="<%=member%>" readonly></TD>
								</TR>

								<TR>
									<TD width="24%" align="right">投诉建议内容:</TD>
